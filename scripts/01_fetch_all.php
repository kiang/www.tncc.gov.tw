...
foreach($nodes AS $node) {
    ...
    while(false === $pageEnd) {
        ...
        if(!file_exists($rawFile)) {
            error_log('fetching https://www.tncc.gov.tw/listm.asp?orcaid=' . $node . '&topage=' . $i);
            file_put_contents($rawFile, file_get_contents('https://www.tncc.gov.tw/listm.asp?orcaid=' . $node . '&topage=' . $i));
        }
